"""
CPT Training Script with FP8/NVFP4 Quantization
...
def setup_model(config: dict, use_fp8: bool = False, use_fsdp: bool = False):
    ...
    # sync_module_states=False: no NCCL broadcast needed since all ranks load identical weights.
...
def main():
    ...
    if args.fsdp:
        ...
        distributed_kwargs = {
            ...
            "fsdp_config": {
                ...
                "sync_module_states": False,  # All ranks load identical weights from disk; no broadcast needed
    ...
    os.environ["TENSORBOARD_LOGGING_DIR"] = training_config.get('logging_dir', 'logs/cpt_training')
